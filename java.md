...
# 个人简介
- 熟练掌握JAVA/J2EE(SpringMVC、Spring、myBatis等)开发技术，了解常用开源技术;
- 熟练掌握Activiti流程引擎、CAS、ActiveMQ、Quertz等;
- 熟练掌握MSSQL、Oracle、MySql等数据库的操作、存储过程编写
- 熟练掌握基于Maven/Grandle的项目构建与管理;
- 熟练运用SVN/GIT等版本控制系统;
...
- 电话召车后台管理系统数据库，程序架构设计，开 以及后续的维护
